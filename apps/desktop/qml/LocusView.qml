...
Rectangle {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            border.color: "#bec5ca"
            RowLayout {
                anchors.fill: parent; anchors.leftMargin: 10; anchors.rightMargin: 10; spacing: 7
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Label { visible:root.distanceMode; text:(root.document ? ((root.cursorATime-root.document.triggerOffsetSeconds)*1000).toFixed(2)+" ms · " : "") + root.compactImpedance(root.cursorAValue); color:"#354049"; font.pixelSize:10 }
                ...
                Label { visible:root.distanceMode; text:(root.document ? ((root.cursorBTime-root.document.triggerOffsetSeconds)*1000).toFixed(2)+" ms · " : "") + root.compactImpedance(root.cursorBValue); color:"#354049"; font.pixelSize:10 }
                Item { Layout.fillWidth:true }
        ...
        Rectangle {
            ...
            Canvas {
                ...
                MouseArea {
                    anchors.fill:parent; enabled:root.distanceMode; acceptedButtons:Qt.LeftButton
            ...
            Label {
                ...
                color:"#8a5f2a";font.pixelSize:12
            }
        }
    }
}
