    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            Row {
                ...
                Label { width: 150; height: parent.height; verticalAlignment: Text.AlignVCenter; text: "C1 instantaneous"; color: "#4d565d"; font.pixelSize: 8; font.weight: Font.DemiBold }
                ...
                Label { width: 150; height: parent.height; verticalAlignment: Text.AlignVCenter; text: "C2 instantaneous"; color: "#4d565d"; font.pixelSize: 8; font.weight: Font.DemiBold }
                ...
                Label { width: 110; height: parent.height; verticalAlignment: Text.AlignVCenter; text: "C2 angle"; color: "#4d565d"; font.pixelSize: 8; font.weight: Font.DemiBold }
            }
        }
            ...
            Column {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        border.color: "#e0e4e7"
                        readonly property var p1: root.analysis ? root.analysis.phasorAt(modelData, root.cursorATime) : ({valid:false})
                        readonly property var p2: root.analysis ? root.analysis.phasorAt(modelData, root.cursorBTime) : ({valid:false})
                        Row {
                            anchors.fill: parent
                            anchors.leftMargin: 8
                            ...
                            Label { width: 150; height: parent.height; verticalAlignment: Text.AlignVCenter; text: root.document ? root.document.sampleValueText(modelData, root.cursorATime) : "—"; color: "#343b40"; font.pixelSize: 8 }
                            Label { width: 145; height: parent.height; verticalAlignment: Text.AlignVCenter; text: root.analysis ? root.analysis.rmsValueText(modelData, root.cursorATime) : "—"; color: "#343b40"; font.pixelSize: 8 }
                            ...
                            Label { width: 150; height: parent.height; verticalAlignment: Text.AlignVCenter; text: root.document ? root.document.sampleValueText(modelData, root.cursorBTime) : "—"; color: "#343b40"; font.pixelSize: 8 }
                            Label { width: 145; height: parent.height; verticalAlignment: Text.AlignVCenter; text: root.analysis ? root.analysis.rmsValueText(modelData, root.cursorBTime) : "—"; color: "#343b40"; font.pixelSize: 8 }
